...
export class PlaylistService {
    constructor(
        @InjectModel(Playlist) private readonly playlistRepostitory: typeof Playlist,
    ...
    async getById(playlistId: number) {
        const playlist = await this.playlistRepostitory.findOne({include: [Track], where: {id: playlistId}});
